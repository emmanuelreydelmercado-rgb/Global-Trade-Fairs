            ...
            <div class="mb-6 border-b border-gray-200">
                <nav class="-mb-px flex space-x-8">
                    ...
                    <a href="/telescope" target="_blank"
                       class="border-transparent text-primary hover:text-blue-700 hover:border-blue-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition flex items-center gap-1">
