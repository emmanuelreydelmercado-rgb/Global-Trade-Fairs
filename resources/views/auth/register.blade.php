...
<head>
    ...
    <title>Register - Global Trade Fairs</title>
...
<header class="sticky top-0 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur border-b dark:border-gray-700 shadow-sm">
    <div class="max-w-7xl mx-auto px-3 sm:px-4 h-16 sm:h-20 grid grid-cols-3 items-center gap-2">
        ...
        <div class="flex justify-center">
            <h2 class="text-base sm:text-lg md:text-xl font-bold text-gray-700 dark:text-gray-300">REGISTER</h2>
        </div>
...
<main class="flex-grow flex items-center justify-center px-3 sm:px-4 py-4 sm:py-6">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border dark:border-gray-700 p-4 sm:p-6 w-full max-w-md">
        <div class="text-center mb-3 sm:mb-4">
            <h3 class="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white">Create Account</h3>
            <p class="text-sm sm:text-base text-gray-500 dark:text-gray-400 mt-1 sm:mt-2">Join us today</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-3">
            ...
            <div>
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Upload your profile photo</div>
            </div>
        ...
        <!-- Google Sign-Up -->
        <a href="{{ route('auth.google.register') }}" class="flex items-center justify-center gap-2 w-full border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm sm:text-base font-semibold py-2.5 sm:py-3 rounded-lg transition-colors active:scale-98 touch-manipulation">
        ...
        <div class="text-center mt-3 sm:mt-4 text-xs sm:text-sm">
            <a href="{{ route('login') }}" class="text-primary hover:underline">Already have an account? Log in</a>
        </div>
    </div>
</main>
