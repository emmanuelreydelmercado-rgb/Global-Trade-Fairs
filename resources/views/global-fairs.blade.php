...
<div x-data="{ 
    ...
    applyTheme() {
        // Only apply dark mode on screens < 1024px as requested
...
class="fixed bottom-0 left-0 w-full bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 z-[100] grid grid-cols-4 gap-1 px-2 py-3 md:hidden shadow-[0_-5px_20px_rgba(0,0,0,0.05)] pb-safe">
    ...
    >
        ...
        >
            <!-- Handle -->
            <div class="w-full flex justify-center pt-3 pb-1" @click="settingsOpen = false">
            ...
            <div class="p-6 overflow-y-auto">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-2 ml-1">Applies only to this device (Mobile/Tablet)</p>
                </div>
...
<style>
    ...
    /* Dark mode basics if not in tailwind base */
    .dark body {
